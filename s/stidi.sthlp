...
{p 4 18 2}
{hi: stidi} {hline 2} Integrated discrimination improvement for survival data
...
{pstd} {cmd: stidi} calculates the integrated discrimination
 improvement (IDI) of a new versus an old risk score for survival data
 in a competing risks setting. Pseudovalues of the cumulative
 incidence function [1] are used in conjunction with the formulas of
 [2]. Specifically, IDI corresponds to the difference in R-squared
...
{pstd}[2]. Chambless LE, Cummiskey CP, Cui G (2011). {it:Several methods to assess improvement in risk prediction models: extension to survival analysis.} Stat Med;{bf:30}(1):22-38.{p_end}
