...
* Version history:
*			:: 0.91 (16Jun2015)
* Addded option for reporting relative IDI defined as obtained IDI divided by
* the slope of the old/original model [See Pencina 2010; DOI: 10.1515/CCLM.2010.340]
*****************************************************************************
program stidirel, eclass
	...
	* Check if some event times are left truncated.
	...
	bootstrap _b, `options': _idirelboot `pseudo' `pred1' `pred2'
end
